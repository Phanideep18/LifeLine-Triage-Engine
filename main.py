...
from DAA_MODULE.sorting import compare_sorting_algorithms, merge_sort, display_patients
...
print("\n========== DAA MODULE ==========")
compare_sorting_algorithms(patients)
...
aged_sorted_patients = merge_sort(aged_patients)
...
updated_sorted_patients = merge_sort(updated_patients)
